...
<template>
  <div class="bg-white rounded-sm p-6">
    <h1 class="text-2xl font-bold mb-6">Lộ trình học tập</h1>

    <div v-if="learningPaths.length === 0" class="text-center py-12">
      <p class="text-gray-500">Bạn chưa có lộ trình học tập nào</p>
    </div>
    ...
    <div v-else class="space-y-6">
      ...
      >
        <div class="flex gap-4 p-4">
          ...
          />
          <div class="flex-1">
            <h3 class="font-semibold text-lg mb-1">{{ path.title }}</h3>
            ...
            <UButton color="primary" class="mt-4">Tiếp tục lộ trình</UButton>
          </div>
        </div>
      </div>
    </div>
