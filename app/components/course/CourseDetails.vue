...
<template>
  <div class="bg-white space-y-6 sticky top-28 rounded-lg shadow-md px-4 py-6 md:shadow-lg md:px-5 md:py-7">
    <Heading
      variant="h5"
      as="h4"
    >
    ...
    <div class="space-y-4 md:space-y-7.5 text-base md:text-lg">
